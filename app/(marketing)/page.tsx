    ...
    <div className="flex items-center justify-center flex-col">
      <div className={cn("flex items-center justify-center flex-col",headingFont.className)}>
        <div className="mg-4 flex items-center justify-center border shadow-sm p-4 bg-amber-100 text-amber-700 rounded-full uppercase">
          ...
          N<sup className="lowercase">o</sup>&nbsp;1 Task Management
        </div>
      ...
      textFont.className)}>
        Colaborate, manage projects, and reach new productivity peeks. From high rises to the ome office , the way your team works is unique - accomplish it all with Taskify.
      </div>
